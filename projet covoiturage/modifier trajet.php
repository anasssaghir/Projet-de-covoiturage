...
if($departure==$row['departure'] && $destination==$row['destination'] && $prix==$row['prix'] && $places_disponibles==$row['places_disponibles'] && $date==$row['date'] 
...
<div class="container-fluid"id="primary">
  <center><h1 style="background-color:#ed2553;border-radius:50px;font-family: 'Baloo Bhai', cursive;box-shadow:5px 5px 9px blue;text-shadow:2px 2px#000;display:inline-block;">Modifier trajet</h1></center><br>
  <div class="container">
    <div class="row">
	<center><?php  echo $msg; ?></center>
     <form class="form-horizontal" method="post">
	  ...
	  <div class="form-group">
        <div class="row">
        <div class="control-label col-sm-4"><h4>Departure :</h4></div>
          <div class="col-sm-8">
          ...
          <div class="form-group">
           <div class="row">
              <div class="control-label col-sm-4"><h4> Destination :</h4></div>
                <div class="col-sm-8">
	  ...
	  <div class="form-group">
        <div class="row">
          <div class="control-label col-sm-4"><h4> Prix :</h4></div>
          <div class="col-sm-8">
      ...
      <div class="form-group">
           <div class="row">
              <div class="control-label col-sm-4"><h4>Places disponibles :</h4></div>
                <div class="col-sm-8">
      ...
      <div class="form-group">
           <div class="row">
              <div class="control-label col-sm-4"><h4>Date :</h4></div>
                <div class="col-sm-8">
      ...
      <div class="form-group">
           <div class="row">
              <div class="control-label col-sm-4"><h4>Temps :</h4></div>
                <div class="col-sm-8">
	        ...
	        <div class="form-group">
           <div class="row">
              <div class="control-label col-sm-4"><h4>Commentaire :</h4></div>
                <div class="col-sm-8">
