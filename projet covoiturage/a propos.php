...
<div class="container"> 
  <div class="row content">
    <div class="col-sm-12">
      <h1 id="font">{ MundiaCovoiturage }</h1><br>
      <p class="text-justify">Informations générales à propos de l'application et ses avantages
<h1 align="center"id="font">[ Services ]</h1><br>
<p class="text-justify">Informations sur les services de l'application</p>
    </div>
  </div><br><br>
  <div class="row"align="center">
  <div class="col-sm-2"style="background-color:#27303b;height:80px;width:100px;">
      <a href="#" type="button" data-toggle="modal" data-target="#myModal"><img src="image/icon-01.png"width="60px;"height="50px;"style="margin-top:15px;"></a>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-2"style="background-color:#27303b;height:80px;width:100px;">
            <a href="#"><img src="image/icon-02.png"width="60px;"height="50px;"style="margin-top:15px;"></a>
        </div>
         <div class="col-sm-2">
          <h4><b>Téléphone</b></h4>
              <b>(+212) 0000000000</b>
        ...
        <div class="col-sm-2"style="background-color:#27303b;height:80px;width:100px;">
            <a href="#"><img src="image/icon-03.png"width="60px;"height="50px;"style="margin-top:15px;"></a>
        </div>
         <div class="col-sm-2">
          <h4><b>Email</b></h4>
              <b>......@gmail.com</b>
